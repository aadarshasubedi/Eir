...
int                     eir_gfx_add_text(eir_gfx_env_t * gfx_env, const char * text, eir_mth_vec2_t * position, float font_size, eir_gfx_color_t * color); // TODO: replace int by another type
...
void eir_gfx_update_text(eir_gfx_env_t * gfx_env, int text_index, const char * text); // TODO: replace int by another type
